...
<html lang="en">
  ...
  <body class="bg-slate-200">
    <div class="w-full h-full">
      ...
      <a href="index.html" class="text-lg block text-slate-200 px-3 py-5 mx-auto"><img src="./components/dash.png" class="h-10 w-auto mx-auto">Dashboard</a>
      <a href="indexLogsMain.html" class="text-lg block text-slate-200 px-3 py-5 mx-auto"><img src="./components/logs.png" class="h-10 w-auto mx-auto">Logs</a>
      <a href="indexLog.html" class="text-lg block text-slate-800 bg-slate-200 px-3 py-5 mx-auto"><img src="./components/notes_d.png" class="h-10 w-auto mx-auto"> Notes</a>
      </div>
